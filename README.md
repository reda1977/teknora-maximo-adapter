...
بعدها افتح المتصفح على: http://localhost:8000 (البورت اللي على المضيف
- عدّله في `docker-compose.yml` لو 8000 كمان محجوز عندك لحاجة تانية؛
الحاوية نفسها دايمًا بتسمع على 8800 من الداخل).
